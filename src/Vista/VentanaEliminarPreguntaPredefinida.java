...
public class VentanaEliminarPreguntaPredefinida extends javax.swing.JFrame {

    public VentanaEliminarPreguntaPredefinida() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar pregunta predefinida");

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Pregunta predefinida:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEliminarPreguntaPredefinida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaEliminarPreguntaPredefinida().setVisible(true);
            }
        });
    }
