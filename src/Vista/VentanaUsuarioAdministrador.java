...
public class VentanaUsuarioAdministrador extends javax.swing.JFrame {
    ...
    private void btnModificarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarUsuarioActionPerformed
        VentanaEditarUsuarioAdministrador ventanaEditarUsuarioAdministrador = new VentanaEditarUsuarioAdministrador();
        ventanaEditarUsuarioAdministrador.setVisible(true);
        this.dispose();
