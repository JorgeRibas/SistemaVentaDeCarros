...
public class VentanaVerEspaciosLibresAdministrador extends javax.swing.JFrame {
    ...
    public VentanaVerEspaciosLibresAdministrador() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaVerEspaciosLibresAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaVerEspaciosLibresAdministrador().setVisible(true);
            }
        });
    }
