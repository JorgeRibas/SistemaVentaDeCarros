...
public class VentanaVerUsuariosAdministrador extends javax.swing.JFrame {
    ...
    public VentanaVerUsuariosAdministrador() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaVerUsuariosAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaVerUsuariosAdministrador().setVisible(true);
            }
        });
    }
