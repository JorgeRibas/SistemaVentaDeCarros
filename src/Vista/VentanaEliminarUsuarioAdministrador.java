...
public class VentanaEliminarUsuarioAdministrador extends javax.swing.JFrame {
    ...
    public VentanaEliminarUsuarioAdministrador() {
        ...
        try {
            ...
            Logger.getLogger(VentanaEliminarUsuarioAdministrador.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        tblUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre completo", "Apellidos", "Nombre de usuario", "Precio base", "Contraseña temporal", "Cédula", "Rol", "Tienda"
            }
        ));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        userFind.setNombreLogin(modeloTabla.getValueAt(rowIndex, 1).toString());

        try {
            userNew = datosUsuario.leerID(userFind);
            datosUsuario.eliminarID(userNew);
