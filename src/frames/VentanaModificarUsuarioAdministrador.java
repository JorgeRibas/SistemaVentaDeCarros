 ...
 * @author dannycolumna
 */
public class VentanaModificarUsuarioAdministrador extends javax.swing.JFrame {

    /**
     * Creates new form VentanaModificarUsuarioAdministrador
     */
    public VentanaModificarUsuarioAdministrador() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaModificarUsuarioAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaModificarUsuarioAdministrador().setVisible(true);
            }
        });
    }
